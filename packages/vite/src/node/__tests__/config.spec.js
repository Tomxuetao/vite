...
describe('resolveConfig', () => {
  ...
  const keepScreenOverridePlugin = () => {
    return {
  ...
  test('plugin merges `clearScreen` option', async () => {
    const config1 = { plugins: [keepScreenMergePlugin()] }
    const config2 = {
  ...
  test('plugin overrides `clearScreen` option', async () => {
    const config1 = { plugins: [keepScreenOverridePlugin()] }
    const config2 = {
