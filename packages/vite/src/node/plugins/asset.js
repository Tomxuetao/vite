...
export function registerCustomMime() {
...
export function renderAssetUrlInJS(ctx, config, chunk, opts, code) {
...
export async function fileToUrl(id, config, ctx) {
