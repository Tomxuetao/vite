...
export function ssrRewriteStacktrace(stack, moduleGraph) {
  calculateOffsetOnce()
  return stack
    .split('\n')
    .map((line) => {
...
export function rebindErrorStacktrace(e, stacktrace) {
...
export function ssrFixStacktrace(e, moduleGraph) {
  if (!e.stack) return
